## Nimada konteynerlarga tasharidan kirib bo'ladi?
```
...
```
Agar sizga kerakli podni tanlashda yordam kerak bo'lsa, uning IP manzilini ko'rishingiz mumkin. Masalan, agar siz `test-server-k8s-1` podiga kirishni xohlasangiz, uning IP manzili `
Lekin podlarga tasharidan kirish uchun sizga pod nomi va namespace kerak bo'ladi. Keyin quyidagi buyruqni ishlatishingiz mumkin:
```
